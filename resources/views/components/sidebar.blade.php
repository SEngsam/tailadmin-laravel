                ...
                <nav x-data="{ selected: $persist('Dashboard') }">
                    ...
                    <div>
                        ...
                        <ul class="flex flex-col gap-4 mb-6">
                            ...
                            <li>
                                ...
                                <div class="overflow-hidden transform translate"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        ...
                                        <li>
                                            <a href="{{ url('/')}}" class="menu-dropdown-item group"
                            ...
                            <!-- Menu Item Calendar -->
                            <li>
                                <a href="{{ url('/calendar')}}" @click="selected = (selected === 'Calendar' ? '':'Calendar')"
                                    class="menu-item group"
                            ...
                            <!-- Menu Item Profile -->
                            <li>
                                <a href="{{url('/profile')}}" @click="selected = (selected === 'Profile' ? '':'Profile')"
                                    class="menu-item group"
                            ...
                            <li>
                                ...
                                <div class="overflow-hidden transform translate"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                        <li>
                                            <a href="{{ url('/form-elements')}}" class="menu-dropdown-item group"
                            ...
                            <li>
                                ...
                                <div class="overflow-hidden transform translate"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                        <li>
                                            <a href="{{url('/basic-tables')}}" class="menu-dropdown-item group"
                            ...
                            <li>
                                ...
                                <div class="overflow-hidden transform translate"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                        <li>
                                            <a href="{{url('/blank')}}" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="{{url('/404')}}" class="menu-dropdown-item group"
                            ...
                            <li>
                                ...
                                <div class="overflow-hidden transform translate"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                        <li>
                                            <a href="{{url('/line-chart')}}" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="{{url('/bar-chart')}}" class="menu-dropdown-item group"
                            ...
                            <li>
                                ...
                                <div class="overflow-hidden transform translate"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                        <li>
                                            <a href="{{url('/alerts')}}" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="{{url('/avatars')}}" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="{{ url('/badge')}}" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="{{ url('/buttons')}}" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="{{ url('/images')}}" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="{{ url('/videos')}}" class="menu-dropdown-item group"
                            ...
                            <li>
                                ...
                                <div class="overflow-hidden transform translate"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                        <li>
                                            <a href="{{url('/signin')}}" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="{{url('/signup')}}" class="menu-dropdown-item group"
